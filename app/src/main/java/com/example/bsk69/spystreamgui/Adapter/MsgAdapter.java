package com.example.bsk69.spystreamgui.Adapter;
...
import com.example.bsk69.spystreamgui.R;
...
public class MsgAdapter extends RecyclerView.Adapter<MsgAdapter.ViewHolder> {
    ...
    public MsgAdapter(Context mContext,List<Chat> mChat,String imageurl){
        this.mChat = mChat;
    ...
    public void onBindViewHolder(@NonNull MsgAdapter.ViewHolder viewHolder, int position) {
        ...
        if (position == mChat.size()-1) {
            if (chat.isIsseen()) {
                viewHolder.txt_seen.setText("Wysyłanie");
            } else {
                viewHolder.txt_seen.setText("Dostarczony");
            }
        }
        else {
